...
public class CommandManagerTest {
    ...
    @Mock
    private Promise<MachineProcessDescriptor>                   processPromise;
    @Captor
    private ArgumentCaptor<Operation<MachineProcessDescriptor>> processCaptor;
    ...
    public void shouldExecuteCommand() throws Exception {
        ...
        MachineProcessDescriptor process = mock(MachineProcessDescriptor.class);
        int pid = 123;
